define(function (require, exports, module) {
    require('css/common/plug/LArea.css');
    ...
    MobileArea.prototype.constructor = MobileArea;

    MobileArea.prototype.init = function(params){
        this.params = params;
    ...
    MobileArea.prototype.getData = function(callback){
        var _self = this;
    ...
    MobileArea.prototype.bindEvent = function(){
        var _self = this;
        //呼出插件
    ...
    //重置节点个数
    MobileArea.prototype.setGearTooth = function(data){
        var _self = this;
        var item = data || [];
        var l = item.length;
    ...
    MobileArea.prototype.finish = function(e){
        var _self = this;
        var area_province = _self.gearArea.querySelector(".area_province");
        var area_city = _self.gearArea.querySelector(".area_city");
        var area_county = _self.gearArea.querySelector(".area_county");
    ...
    MobileArea.prototype.close = function(e){
        e.preventDefault();
        var _self = this;
