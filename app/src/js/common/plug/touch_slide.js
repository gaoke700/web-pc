define(function (require, exports, module) {
    ...
    var TouchSlide = function (a) {
        ...
        var opts = {
            ...
            slideCellIndex: a.slideCellIndex || 0,
        ...
        var slideCell = document.querySelectorAll(opts.slideCell)[opts.slideCellIndex];
        ...
        require.async('js/common/plug/lazy_load_last.js', function(lazyLoad){
            lazyLoad();
        });
